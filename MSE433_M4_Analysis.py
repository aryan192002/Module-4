"""
MSE 433 Module 4: EP Lab AFib Ablation — Complete Statistical Analysis
=====================================================================
This script reproduces ALL statistical tests, charts, and factor analysis
used in the presentation. Each section includes reasoning for the methods chosen
and interpretation of key values (r, p, F, CV, etc.).

Authors: MSE 433 Team | Winter 2026
Data: MSE433_M4_Data.xlsx (150 cases, 3 physicians, Jan–Oct 2025)
"""
...
df = pd.read_excel('/mnt/user-data/uploads/MSE433_M4_Data.xlsx',
...
plt.tight_layout()
plt.savefig('/home/claude/cv_by_step.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('/home/claude/standard_vs_extra.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('/home/claude/correlations.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('/home/claude/numabl_vs_casetime.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('/home/claude/case_sequence.png', dpi=150, bbox_inches='tight')
plt.close()
...
print("\n" + "=" * 70)
print("ANALYSIS COMPLETE — All charts saved to /home/claude/")
print("=" * 70)
print("\nGenerated files:")
